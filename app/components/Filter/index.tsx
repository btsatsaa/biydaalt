...
const NamesList = () => {
  ...
  return (
    <Container id="home-section" className="container">
      ...
      <div className="relative text-whit mx-auto max-w-7xl sm:pb-0 px-0 focus-within:text-white flex flex-row-reverse input-shadow rounded-full pt-2 lg:pt-0">
        <input
          type="Email address"
          name="q"
        ...
        <div key={index}>
          <div className="text-lg sm:text-sm py-0 lg:py-0 ">
            <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1   ">
              ...
              /> */}
                  <Link href="localhost:3000/myrate">
                    <img
              ...
              <div className="col-span-6 bg:{style.bgCustom} ">
                ...
                <div className="flex justify-between">
                  <div className=" bg-lightkblue flex mt-2  text-sm  border-solid border-2 font-semibold border-grey500 rounded-md p-2">
                    <p>Нэр:</p>
                    {item.lesson_name}
                  </div>
